...
/* date last modified: 2025-08-19 16:32:33 */
...
function main() {
            addJs('https://clustrmaps.com/bl/scripts/counter.js', "2247583");
...
function embed_clustrmaps(script_el, embed_after_script){
    ...
    if($('#clustrmaps-widget-v2').length === 0){
        ...
        */
                            var link = '<a target="_top" href="http://clustrmaps.com/site/1c68v" title="ClustrMaps People Search" id="clustrmaps-widget-v2">';
